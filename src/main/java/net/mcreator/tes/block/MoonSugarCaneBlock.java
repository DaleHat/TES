...
public class MoonSugarCaneBlock extends TesModElements.ModElement {
	@ObjectHolder("tes:moon_sugar_cane")
	public static final Block block = null;
	public MoonSugarCaneBlock(TesModElements instance) {
		super(instance, 55);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("moon_sugar_cane"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tes:moon_sugar_cane"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("moon_sugar_cane");
		}
