...
public class MolagAmurBiome extends TesModElements.ModElement {
	public static Biome biome;
	public MolagAmurBiome(TesModElements instance) {
		super(instance, 41);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:molag_amur"));
			}
		}
	}
	@Override
