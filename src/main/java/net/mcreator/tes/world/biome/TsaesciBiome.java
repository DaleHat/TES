...
public class TsaesciBiome extends TesModElements.ModElement {
	public static Biome biome;
	public TsaesciBiome(TesModElements instance) {
		super(instance, 106);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:tsaesci"));
			}
		}
	}
	@Override
