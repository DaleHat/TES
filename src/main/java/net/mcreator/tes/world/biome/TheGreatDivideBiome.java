...
public class TheGreatDivideBiome extends TesModElements.ModElement {
	public static Biome biome;
	public TheGreatDivideBiome(TesModElements instance) {
		super(instance, 65);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:the_great_divide"));
			}
		}
	}
	@Override
