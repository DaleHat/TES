...
public class KamalMountainsBiome extends TesModElements.ModElement {
	public static Biome biome;
	public KamalMountainsBiome(TesModElements instance) {
		super(instance, 105);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:kamal_mountains"));
			}
		}
	}
	@Override
