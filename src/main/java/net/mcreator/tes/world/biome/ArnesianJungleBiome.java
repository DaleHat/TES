...
public class ArnesianJungleBiome extends TesModElements.ModElement {
	public static Biome biome;
	public ArnesianJungleBiome(TesModElements instance) {
		super(instance, 83);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:arnesian_jungle"));
			}
		}
	}
	@Override
