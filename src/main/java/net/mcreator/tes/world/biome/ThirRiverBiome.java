...
public class ThirRiverBiome extends TesModElements.ModElement {
	public static Biome biome;
	public ThirRiverBiome(TesModElements instance) {
		super(instance, 53);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:thir_river"));
			}
		}
	}
	@Override
