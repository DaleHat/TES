...
public class SamaraBiome extends TesModElements.ModElement {
	public static Biome biome;
	public SamaraBiome(TesModElements instance) {
		super(instance, 126);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:samara"));
			}
		}
	}
	@Override
