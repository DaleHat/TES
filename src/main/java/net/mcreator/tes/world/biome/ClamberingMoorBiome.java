...
public class ClamberingMoorBiome extends TesModElements.ModElement {
	public static Biome biome;
	public ClamberingMoorBiome(TesModElements instance) {
		super(instance, 90);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:clambering_moor"));
			}
		}
	}
	@Override
