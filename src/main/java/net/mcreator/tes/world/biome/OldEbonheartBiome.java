...
public class OldEbonheartBiome extends TesModElements.ModElement {
	public static Biome biome;
	public OldEbonheartBiome(TesModElements instance) {
		super(instance, 79);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:old_ebonheart"));
			}
		}
	}
	@Override
