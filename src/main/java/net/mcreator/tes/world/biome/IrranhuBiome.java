...
public class IrranhuBiome extends TesModElements.ModElement {
	public static Biome biome;
	public IrranhuBiome(TesModElements instance) {
		super(instance, 121);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:irranhu"));
			}
		}
	}
	@Override
