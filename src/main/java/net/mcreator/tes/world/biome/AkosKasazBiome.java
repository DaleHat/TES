...
public class AkosKasazBiome extends TesModElements.ModElement {
	public static Biome biome;
	public AkosKasazBiome(TesModElements instance) {
		super(instance, 112);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:akos_kasaz"));
			}
		}
	}
	@Override
