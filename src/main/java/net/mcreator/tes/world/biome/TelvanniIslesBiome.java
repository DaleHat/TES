...
public class TelvanniIslesBiome extends TesModElements.ModElement {
	public static Biome biome;
	public TelvanniIslesBiome(TesModElements instance) {
		super(instance, 70);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:telvanni_isles"));
			}
		}
	}
	@Override
