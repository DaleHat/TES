...
public class LakeNabiaBiome extends TesModElements.ModElement {
	public static Biome biome;
	public LakeNabiaBiome(TesModElements instance) {
		super(instance, 50);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:lake_nabia"));
			}
		}
	}
	@Override
