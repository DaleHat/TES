...
public class TheSpineBiome extends TesModElements.ModElement {
	public static Biome biome;
	public TheSpineBiome(TesModElements instance) {
		super(instance, 135);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:the_spine"));
			}
		}
	}
	@Override
