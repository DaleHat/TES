...
public class DeshaanPlainsBiome extends TesModElements.ModElement {
	public static Biome biome;
	public DeshaanPlainsBiome(TesModElements instance) {
		super(instance, 81);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:deshaan_plains"));
			}
		}
	}
	@Override
