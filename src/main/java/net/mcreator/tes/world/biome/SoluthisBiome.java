...
public class SoluthisBiome extends TesModElements.ModElement {
	public static Biome biome;
	public SoluthisBiome(TesModElements instance) {
		super(instance, 95);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:soluthis"));
			}
		}
	}
	@Override
