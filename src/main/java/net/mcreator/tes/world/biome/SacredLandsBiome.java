...
public class SacredLandsBiome extends TesModElements.ModElement {
	public static Biome biome;
	public SacredLandsBiome(TesModElements instance) {
		super(instance, 73);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:sacred_lands"));
			}
		}
	}
	@Override
