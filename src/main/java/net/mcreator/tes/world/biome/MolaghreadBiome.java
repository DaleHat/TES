...
public class MolaghreadBiome extends TesModElements.ModElement {
	public static Biome biome;
	public MolaghreadBiome(TesModElements instance) {
		super(instance, 67);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:molaghread"));
			}
		}
	}
	@Override
