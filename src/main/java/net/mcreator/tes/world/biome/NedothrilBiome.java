...
public class NedothrilBiome extends TesModElements.ModElement {
	public static Biome biome;
	public NedothrilBiome(TesModElements instance) {
		super(instance, 74);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:nedothril"));
			}
		}
	}
	@Override
