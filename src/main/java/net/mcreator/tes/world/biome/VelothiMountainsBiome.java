...
public class VelothiMountainsBiome extends TesModElements.ModElement {
	public static Biome biome;
	public VelothiMountainsBiome(TesModElements instance) {
		super(instance, 94);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:velothi_mountains"));
			}
		}
	}
	@Override
