...
public class NibenayBayBiome extends TesModElements.ModElement {
	public static Biome biome;
	public NibenayBayBiome(TesModElements instance) {
		super(instance, 140);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:nibenay_bay"));
			}
		}
	}
	@Override
