...
public class OdaiRiverBiome extends TesModElements.ModElement {
	public static Biome biome;
	public OdaiRiverBiome(TesModElements instance) {
		super(instance, 51);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:odai_river"));
			}
		}
	}
	@Override
