...
public class AanthirinBiome extends TesModElements.ModElement {
	public static Biome biome;
	public AanthirinBiome(TesModElements instance) {
		super(instance, 78);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:aanthirin"));
			}
		}
	}
	@Override
