...
public class InnerSeaBiome extends TesModElements.ModElement {
	public static Biome biome;
	public InnerSeaBiome(TesModElements instance) {
		super(instance, 46);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:inner_sea"));
			}
		}
	}
	@Override
