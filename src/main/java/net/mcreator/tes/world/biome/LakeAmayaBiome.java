...
public class LakeAmayaBiome extends TesModElements.ModElement {
	public static Biome biome;
	public LakeAmayaBiome(TesModElements instance) {
		super(instance, 47);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:lake_amaya"));
			}
		}
	}
	@Override
