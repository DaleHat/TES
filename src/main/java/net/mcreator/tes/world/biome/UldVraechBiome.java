...
public class UldVraechBiome extends TesModElements.ModElement {
	public static Biome biome;
	public UldVraechBiome(TesModElements instance) {
		super(instance, 93);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:uld_vraech"));
			}
		}
	}
	@Override
