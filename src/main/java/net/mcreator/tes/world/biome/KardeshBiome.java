...
public class KardeshBiome extends TesModElements.ModElement {
	public static Biome biome;
	public KardeshBiome(TesModElements instance) {
		super(instance, 123);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:kardesh"));
			}
		}
	}
	@Override
