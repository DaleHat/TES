...
public class AltOrethanBiome extends TesModElements.ModElement {
	public static Biome biome;
	public AltOrethanBiome(TesModElements instance) {
		super(instance, 76);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:alt_orethan"));
			}
		}
	}
	@Override
