...
public class JulanSharBiome extends TesModElements.ModElement {
	public static Biome biome;
	public JulanSharBiome(TesModElements instance) {
		super(instance, 92);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:julan_shar"));
			}
		}
	}
	@Override
