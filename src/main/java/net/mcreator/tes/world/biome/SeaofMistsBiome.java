...
public class SeaofMistsBiome extends TesModElements.ModElement {
	public static Biome biome;
	public SeaofMistsBiome(TesModElements instance) {
		super(instance, 139);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:seaof_mists"));
			}
		}
	}
	@Override
