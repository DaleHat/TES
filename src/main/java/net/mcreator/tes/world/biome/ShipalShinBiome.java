...
public class ShipalShinBiome extends TesModElements.ModElement {
	public static Biome biome;
	public ShipalShinBiome(TesModElements instance) {
		super(instance, 86);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:shipal_shin"));
			}
		}
	}
	@Override
