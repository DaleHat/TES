...
public class LakeHairanBiome extends TesModElements.ModElement {
	public static Biome biome;
	public LakeHairanBiome(TesModElements instance) {
		super(instance, 48);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:lake_hairan"));
			}
		}
	}
	@Override
