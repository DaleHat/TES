...
public class TopalBayBiome extends TesModElements.ModElement {
	public static Biome biome;
	public TopalBayBiome(TesModElements instance) {
		super(instance, 141);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:topal_bay"));
			}
		}
	}
	@Override
