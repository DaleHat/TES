...
public class HerneBiome extends TesModElements.ModElement {
	public static Biome biome;
	public HerneBiome(TesModElements instance) {
		super(instance, 131);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:herne"));
			}
		}
	}
	@Override
