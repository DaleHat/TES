...
public class AscadianBluffsBiome extends TesModElements.ModElement {
	public static Biome biome;
	public AscadianBluffsBiome(TesModElements instance) {
		super(instance, 89);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:ascadian_bluffs"));
			}
		}
	}
	@Override
