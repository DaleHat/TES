...
public class SeaofGhostsBiome extends TesModElements.ModElement {
	public static Biome biome;
	public SeaofGhostsBiome(TesModElements instance) {
		super(instance, 60);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:sea_of_ghosts"));
			}
		}
	}
	@Override
