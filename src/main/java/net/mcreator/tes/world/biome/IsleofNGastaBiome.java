...
public class IsleofNGastaBiome extends TesModElements.ModElement {
	public static Biome biome;
	public IsleofNGastaBiome(TesModElements instance) {
		super(instance, 136);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:isleof_n_gasta"));
			}
		}
	}
	@Override
