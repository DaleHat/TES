...
public class AranyonPassBiome extends TesModElements.ModElement {
	public static Biome biome;
	public AranyonPassBiome(TesModElements instance) {
		super(instance, 69);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:aranyon_pass"));
			}
		}
	}
	@Override
