...
public class MudflatsBiome extends TesModElements.ModElement {
	public static Biome biome;
	public MudflatsBiome(TesModElements instance) {
		super(instance, 80);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:mudflats"));
			}
		}
	}
	@Override
