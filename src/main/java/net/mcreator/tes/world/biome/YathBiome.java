...
public class YathBiome extends TesModElements.ModElement {
	public static Biome biome;
	public YathBiome(TesModElements instance) {
		super(instance, 127);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:yath"));
			}
		}
	}
	@Override
