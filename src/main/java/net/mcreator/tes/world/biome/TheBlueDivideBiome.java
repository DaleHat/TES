...
public class TheBlueDivideBiome extends TesModElements.ModElement {
	public static Biome biome;
	public TheBlueDivideBiome(TesModElements instance) {
		super(instance, 64);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:the_blue_divide"));
			}
		}
	}
	@Override
