...
public class LanOrethanBiome extends TesModElements.ModElement {
	public static Biome biome;
	public LanOrethanBiome(TesModElements instance) {
		super(instance, 75);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:lan_orethan"));
			}
		}
	}
	@Override
