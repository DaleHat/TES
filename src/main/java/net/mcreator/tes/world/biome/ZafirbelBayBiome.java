...
public class ZafirbelBayBiome extends TesModElements.ModElement {
	public static Biome biome;
	public ZafirbelBayBiome(TesModElements instance) {
		super(instance, 54);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:zafirbel_bay"));
			}
		}
	}
	@Override
