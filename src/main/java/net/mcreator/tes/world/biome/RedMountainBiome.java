...
public class RedMountainBiome extends TesModElements.ModElement {
	public static Biome biome;
	public RedMountainBiome(TesModElements instance) {
		super(instance, 42);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.NONE).category(Biome.Category.DESERT).depth(1f).scale(0.2f).temperature(1.5f)
						.downfall(0f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("tes:red_mountain"));
			}
		}
	}
	@Override
