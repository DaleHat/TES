...
public class MoniBiome extends TesModElements.ModElement {
	public static Biome biome;
	public MoniBiome(TesModElements instance) {
		super(instance, 125);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:moni"));
			}
		}
	}
	@Override
