...
public class AshlandsBiome extends TesModElements.ModElement {
	public static Biome biome;
	public AshlandsBiome(TesModElements instance) {
		super(instance, 37);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:ashlands"));
			}
		}
	}
	@Override
