...
public class AlikrDesertBiome extends TesModElements.ModElement {
	public static Biome biome;
	public AlikrDesertBiome(TesModElements instance) {
		super(instance, 138);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:alikr_desert"));
			}
		}
	}
	@Override
