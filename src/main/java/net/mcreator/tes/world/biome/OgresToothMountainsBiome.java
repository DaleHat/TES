...
public class OgresToothMountainsBiome extends TesModElements.ModElement {
	public static Biome biome;
	public OgresToothMountainsBiome(TesModElements instance) {
		super(instance, 133);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:ogres_tooth_mountains"));
			}
		}
	}
	@Override
