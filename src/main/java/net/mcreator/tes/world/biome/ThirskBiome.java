...
public class ThirskBiome extends TesModElements.ModElement {
	public static Biome biome;
	public ThirskBiome(TesModElements instance) {
		super(instance, 100);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:thirsk"));
			}
		}
	}
	@Override
