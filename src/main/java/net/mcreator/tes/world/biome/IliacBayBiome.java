...
public class IliacBayBiome extends TesModElements.ModElement {
	public static Biome biome;
	public IliacBayBiome(TesModElements instance) {
		super(instance, 63);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:iliac_bay"));
			}
		}
	}
	@Override
