...
public class ArmunAshlandsBiome extends TesModElements.ModElement {
	public static Biome biome;
	public ArmunAshlandsBiome(TesModElements instance) {
		super(instance, 87);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:armun_ashlands"));
			}
		}
	}
	@Override
