...
public class ThirrValleyBiome extends TesModElements.ModElement {
	public static Biome biome;
	public ThirrValleyBiome(TesModElements instance) {
		super(instance, 84);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:thirr_valley"));
			}
		}
	}
	@Override
