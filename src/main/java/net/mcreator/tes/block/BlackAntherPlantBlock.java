...
public class BlackAntherPlantBlock extends TesModElements.ModElement {
	@ObjectHolder("tes:black_anther_plant")
	public static final Block block = null;
	public BlackAntherPlantBlock(TesModElements instance) {
		super(instance, 23);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("black_anther_plant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tes:black_anther_plant"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("black_anther_plant");
		}
