...
public class BrodirGroveBiome extends TesModElements.ModElement {
	public static Biome biome;
	public BrodirGroveBiome(TesModElements instance) {
		super(instance, 97);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:brodir_grove"));
			}
		}
	}
	@Override
