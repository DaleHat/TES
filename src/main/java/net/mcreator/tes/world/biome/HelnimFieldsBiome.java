...
public class HelnimFieldsBiome extends TesModElements.ModElement {
	public static Biome biome;
	public HelnimFieldsBiome(TesModElements instance) {
		super(instance, 71);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:helnim_fields"));
			}
		}
	}
	@Override
