...
public class KaPoTunBiome extends TesModElements.ModElement {
	public static Biome biome;
	public KaPoTunBiome(TesModElements instance) {
		super(instance, 108);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:ka_po_tun"));
			}
		}
	}
	@Override
