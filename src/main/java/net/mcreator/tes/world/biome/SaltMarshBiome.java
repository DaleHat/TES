...
public class SaltMarshBiome extends TesModElements.ModElement {
	public static Biome biome;
	public SaltMarshBiome(TesModElements instance) {
		super(instance, 82);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:salt_marsh"));
			}
		}
	}
	@Override
