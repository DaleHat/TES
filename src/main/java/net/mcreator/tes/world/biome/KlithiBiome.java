...
public class KlithiBiome extends TesModElements.ModElement {
	public static Biome biome;
	public KlithiBiome(TesModElements instance) {
		super(instance, 124);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:klithi"));
			}
		}
	}
	@Override
