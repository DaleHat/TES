...
public class SunderedScarBiome extends TesModElements.ModElement {
	public static Biome biome;
	public SunderedScarBiome(TesModElements instance) {
		super(instance, 77);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:sundered_scar"));
			}
		}
	}
	@Override
