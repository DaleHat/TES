...
public class BoethiahsSpineBiome extends TesModElements.ModElement {
	public static Biome biome;
	public BoethiahsSpineBiome(TesModElements instance) {
		super(instance, 68);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:boethiahs_spine"));
			}
		}
	}
	@Override
