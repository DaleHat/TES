...
public class StoneflowerPlantBlock extends TesModElements.ModElement {
	@ObjectHolder("tes:stoneflower_plant")
	public static final Block block = null;
	public StoneflowerPlantBlock(TesModElements instance) {
		super(instance, 25);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("stoneflower_plant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tes:stoneflower_plant"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("stoneflower_plant");
		}
