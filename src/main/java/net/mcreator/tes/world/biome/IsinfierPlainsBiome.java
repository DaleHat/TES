...
public class IsinfierPlainsBiome extends TesModElements.ModElement {
	public static Biome biome;
	public IsinfierPlainsBiome(TesModElements instance) {
		super(instance, 98);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:isinfier_plains"));
			}
		}
	}
	@Override
