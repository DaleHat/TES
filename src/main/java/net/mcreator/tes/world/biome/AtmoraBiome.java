...
public class AtmoraBiome extends TesModElements.ModElement {
	public static Biome biome;
	public AtmoraBiome(TesModElements instance) {
		super(instance, 102);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:atmora"));
			}
		}
	}
	@Override
