...
public class KaneshBiome extends TesModElements.ModElement {
	public static Biome biome;
	public KaneshBiome(TesModElements instance) {
		super(instance, 122);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:kanesh"));
			}
		}
	}
	@Override
