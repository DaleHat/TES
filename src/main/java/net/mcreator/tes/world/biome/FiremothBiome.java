...
public class FiremothBiome extends TesModElements.ModElement {
	public static Biome biome;
	public FiremothBiome(TesModElements instance) {
		super(instance, 66);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:firemoth"));
			}
		}
	}
	@Override
