...
public class ComberryBlock extends TesModElements.ModElement {
	@ObjectHolder("tes:comberry")
	public static final Block block = null;
	public ComberryBlock(TesModElements instance) {
		super(instance, 16);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("comberry"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tes:comberry"), configuredFeature);
		}
	}
	@SubscribeEvent
