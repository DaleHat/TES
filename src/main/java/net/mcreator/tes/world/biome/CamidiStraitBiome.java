...
public class CamidiStraitBiome extends TesModElements.ModElement {
	public static Biome biome;
	public CamidiStraitBiome(TesModElements instance) {
		super(instance, 142);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:camidi_strait"));
			}
		}
	}
	@Override
