...
public class OthrelethWoodsBiome extends TesModElements.ModElement {
	public static Biome biome;
	public OthrelethWoodsBiome(TesModElements instance) {
		super(instance, 85);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:othreleth_woods"));
			}
		}
	}
	@Override
