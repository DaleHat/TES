...
public class BahiaBiome extends TesModElements.ModElement {
	public static Biome biome;
	public BahiaBiome(TesModElements instance) {
		super(instance, 120);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:bahia"));
			}
		}
	}
	@Override
