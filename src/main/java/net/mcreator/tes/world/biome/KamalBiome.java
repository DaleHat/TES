...
public class KamalBiome extends TesModElements.ModElement {
	public static Biome biome;
	public KamalBiome(TesModElements instance) {
		super(instance, 104);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:kamal"));
			}
		}
	}
	@Override
