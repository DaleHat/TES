...
public class MephalanValesBiome extends TesModElements.ModElement {
	public static Biome biome;
	public MephalanValesBiome(TesModElements instance) {
		super(instance, 72);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:mephalan_vales"));
			}
		}
	}
	@Override
