...
public class RothRorynBiome extends TesModElements.ModElement {
	public static Biome biome;
	public RothRorynBiome(TesModElements instance) {
		super(instance, 88);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:roth_roryn"));
			}
		}
	}
	@Override
