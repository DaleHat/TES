...
public class GreyMeadowsBiome extends TesModElements.ModElement {
	public static Biome biome;
	public GreyMeadowsBiome(TesModElements instance) {
		super(instance, 91);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("tes:grey_meadows"));
			}
		}
	}
	@Override
